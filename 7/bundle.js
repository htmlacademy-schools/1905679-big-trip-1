...
const OFFERS = [{
  ...
  price: 20,
  isChosen: Boolean((0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.getRandomInteger)(0, 1))
}, {
  offerType: 'Flight',
...
const generateDescription = () => {
  const randomIndex = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(0, _const_js__WEBPACK_IMPORTED_MODULE_1__.TEXT.length - 1);
  let decription = '';

  for (let i = 0; i < (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(1, 5); i++) {
...
const generatePicture = () => {
  ...
  for (let i = 0; i < 4; i++) {
    picture.push(`http://picsum.photos/248/152?r=${(0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(1, 100)}`);
  }
...
const generateDates = () => {
  const maxDaysGap = 7;
  const daysGap = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(0, maxDaysGap);
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(daysGap, 'day').toDate();
};

const getRandomWaypointType = () => {
  const randomIndex = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(0, _const_js__WEBPACK_IMPORTED_MODULE_1__.WAYPOINTTYPES.length - 1);
  return _const_js__WEBPACK_IMPORTED_MODULE_1__.WAYPOINTTYPES[randomIndex];
};

const getRandomCity = () => {
  const randomIndex = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(0, _const_js__WEBPACK_IMPORTED_MODULE_1__.CITIES.length - 1);
  return _const_js__WEBPACK_IMPORTED_MODULE_1__.CITIES[randomIndex];
};

const getOffer = () => {
  const randomIndex = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(0, _const_js__WEBPACK_IMPORTED_MODULE_1__.OFFERS.length - 1);
  return _const_js__WEBPACK_IMPORTED_MODULE_1__.OFFERS[randomIndex];
};

const getRandomPrice = () => (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(20, 600);
...
const generateWaypoint = () => {
  ...
  return {
    ...
    isFavorite: Boolean((0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.getRandomInteger)(0, 1)),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteEditForm)
/* harmony export */ });
...
class SiteEditForm extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return createSiteEditForm(_classPrivateFieldGet(this, _waypoint));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteEmptyList)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");


const createSiteEmptyList = () => `<p class="trip-events__msg">Click New Event to create your first point</p>
...
class SiteEmptyList extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteEventList)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class SiteEventList extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteFilters)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class SiteFilters extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
class SiteInfo extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return createSiteInfo(_classPrivateFieldGet(this, _waypoints));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteNavigation)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
class SiteNavigation extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteSort)
/* harmony export */ });
/* harmony import */ var _abstract_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-view */ "./src/view/abstract-view.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ SiteWayPoint)
/* harmony export */ });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
...
class SiteWayPoint extends _abstract_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(waypoint) {
    super();
  ...
  get template() {
    return createSiteWayPoint(_classPrivateFieldGet(this, _waypoint));
  }
...
/* harmony import */ var _view_site_empty_list_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./view/site-empty-list.js */ "./src/view/site-empty-list.js");
...
const renderWaypoint = (eventListElement, waypoint) => {
  const waypointComponent = new _view_site_waypoint_js__WEBPACK_IMPORTED_MODULE_2__["default"](waypoint);
  const waypointEditComponent = new _view_site_edit_form_js__WEBPACK_IMPORTED_MODULE_4__["default"](waypoint);

  const replaceWaypointToEdit = () => {
    (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.replace)(waypointEditComponent, waypointComponent);
  };

  const replaceEditToWaypoint = () => {
    (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.replace)(waypointComponent, waypointEditComponent);
  };
  ...
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(eventListElement, waypointComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
};

if (wayPoint.length === 0) {
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteNavigation, new _view_site_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteFilters, new _view_site_filters_js__WEBPACK_IMPORTED_MODULE_5__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteEventsElement, new _view_site_empty_list_js__WEBPACK_IMPORTED_MODULE_9__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
} else {
  const eventListComponent = new _view_site_event_list_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteEventsElement, eventListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
  const siteEventsListElement = siteEventsElement.querySelector('.trip-events__list');
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteMenu, new _view_site_info_js__WEBPACK_IMPORTED_MODULE_7__["default"](wayPoint), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteNavigation, new _view_site_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteFilters, new _view_site_filters_js__WEBPACK_IMPORTED_MODULE_5__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
  (0,_utils_render__WEBPACK_IMPORTED_MODULE_0__.render)(siteEventsListElement, new _view_site_sort_js__WEBPACK_IMPORTED_MODULE_3__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
